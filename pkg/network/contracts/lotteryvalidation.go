...
//
// Solidity: function tokenIds() view returns(uint256 _value)
func (_LotteryValidation *LotteryValidationCaller) TokenIds(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _LotteryValidation.contract.Call(opts, &out, "tokenIds")
...
//
// Solidity: function tokenIds() view returns(uint256 _value)
func (_LotteryValidation *LotteryValidationSession) TokenIds() (*big.Int, error) {
	return _LotteryValidation.Contract.TokenIds(&_LotteryValidation.CallOpts)
}

// TokenIds is a free data retrieval call binding the contract method 0x714cff56.
//
// Solidity: function tokenIds() view returns(uint256 _value)
func (_LotteryValidation *LotteryValidationCallerSession) TokenIds() (*big.Int, error) {
	return _LotteryValidation.Contract.TokenIds(&_LotteryValidation.CallOpts)
}
...
//
// Solidity: function mint(string imageURL, string hash, string externalURL, uint256 minHeight, uint256 maxHeight) returns()
func (_LotteryValidation *LotteryValidationTransactor) Mint(opts *bind.TransactOpts, imageURL string, hash string, externalURL string, minHeight *big.Int, maxHeight *big.Int) (*types.Transaction, error) {
	return _LotteryValidation.contract.Transact(opts, "mint", imageURL, hash, externalURL, minHeight, maxHeight)
}

// Mint is a paid mutator transaction binding the contract method 0x89ca53a8.
//
// Solidity: function mint(string imageURL, string hash, string externalURL, uint256 minHeight, uint256 maxHeight) returns()
func (_LotteryValidation *LotteryValidationSession) Mint(imageURL string, hash string, externalURL string, minHeight *big.Int, maxHeight *big.Int) (*types.Transaction, error) {
	return _LotteryValidation.Contract.Mint(&_LotteryValidation.TransactOpts, imageURL, hash, externalURL, minHeight, maxHeight)
}

// Mint is a paid mutator transaction binding the contract method 0x89ca53a8.
//
// Solidity: function mint(string imageURL, string hash, string externalURL, uint256 minHeight, uint256 maxHeight) returns()
func (_LotteryValidation *LotteryValidationTransactorSession) Mint(imageURL string, hash string, externalURL string, minHeight *big.Int, maxHeight *big.Int) (*types.Transaction, error) {
	return _LotteryValidation.Contract.Mint(&_LotteryValidation.TransactOpts, imageURL, hash, externalURL, minHeight, maxHeight)
}
